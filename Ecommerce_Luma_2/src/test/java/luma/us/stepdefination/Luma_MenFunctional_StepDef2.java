...
import luma.us.pagefactory.LoginLuma_PF2;

public class Luma_MenFunctional_StepDef2 extends BasePage {
	...
	public void user_already_logged_in_the_application_and_verify_the_user_information_on_the_landing_page() {
		...
		pf = PageFactory.initElements(driver, LoginLuma_PF2.class);
		pf.getLogin();
	...
	@When("User should be able to select the specific items M and Blue and {int} then click on the add to cart")
